...
# Game Play
This terminal program supports a variety of commands to make the gameplay easy and smooth. 

This program supports hosting multiple games over websocket connections with database persistence of each game.
After registering and logging in, a user is able to list and view all active games on the server.

![ListGames](shared/project_images/ListGames.png)

You can join as white or black players and the UI will show you your side of the board.

![JoinGameBlack](/shared/project_images/JoinGameBlack.png)
![JoinGameWhite](/shared/project_images/JoinGameWhite.png)
